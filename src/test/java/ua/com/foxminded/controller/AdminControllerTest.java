...
public class AdminControllerTest {
    ...
    @Test
    @WithMockUser(value = "user")
    public void givenPostRequest_shouldRedirectToAdminPanel() throws Exception {
        mvc.perform(post("/admin-panel/save").with(csrf()))
            .andExpect(status().is3xxRedirection());
    }

    @Test
    @WithMockUser(value = "user")
    public void givenGetSingleEntityRequest_shouldReturnSingleUserView() throws Exception{
